...
contract PlotToken is ERC721Mintable, ERC721Burnable, ERC721Enumerable, Ownable {
  ...
  function mint(address owner) public onlyOwner isContractActive returns(uint256){
    tokensCreated ++;
    uint256 plotId = tokensCreated;
    mint(owner, plotId);
